...
//public class CustomerController_Old : MonoBehaviour, ITickUpdatable, IMinuteUpdatable
//{
//    // todo: 加寻路逻辑
...
//    // 摊位设施
//    private PlayerStore_Entity storeEntity;     // 接受摊位内容
//    private PlayerStore_Entity targetEntity;    // 什么时候以摊位为寻路目标
...
//    // 排队点
//    private Vector2 queueTargetPos;
...
//        // 防止非队首进入 Buy 状态
//        if (!targetEntity.IsQueueFront(this))
//        {
//            ChangeState(State.Attracting);
//            return;
//        }
...
//    {
//        int currentListPlace = targetEntity.GetQueueIndex(this);
//        // todo: 吸引函数
//    }
...
//        if(r >= 80)
//        {
//            aContainer = storeEntity.shelfContainer;
//            aCount = storeEntity.shelfContainer.SlotCount;

//            bContainer = storeEntity.saleContainer;
//            bCount = storeEntity.saleContainer.SlotCount;
//        }
//        else
//        {
//            aContainer = storeEntity.saleContainer;
//            aCount = storeEntity.saleContainer.SlotCount;

//            bContainer = storeEntity.shelfContainer;
//            bCount = storeEntity.shelfContainer.SlotCount;
//        }
